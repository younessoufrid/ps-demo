...
@AllArgsConstructor
@NoArgsConstructor
public class ImportCsvRowFormat {
    ...
    @ExcelBindByName(column = ExcelCsvColumn.Values.DATE, required = true)
    @ExcelDate(value = "dd/MM/yyyy")
    @CsvCustomBindByName(column = ExcelCsvColumn.Values.DATE, required = true, converter = CustomDateConverter.class)
    private Date date;
    ...
    @ExcelBindByName(column = ExcelCsvColumn.Values.QUANTITY, required = true)
    @ExcelNumber("#,##0.00")
    @CsvCustomBindByName(column = ExcelCsvColumn.Values.QUANTITY, required = true, converter = CustomComaSeparatorDoubleConverter.class)
